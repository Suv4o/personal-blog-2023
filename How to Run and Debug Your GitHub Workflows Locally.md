...
![image_002_playful.png](attachment:62b9612e-a449-45d8-bd2a-8f918c0df2a9:image_002_playful.png)
...
That's exactly what [**act**](https://github.com/nektos/act) does.
...
![why-test-github-actions-locally.jpg](attachment:97bcdd7f-717b-410a-b299-3a2fbe1b2c87:why-test-github-actions-locally.jpg)
...
For complex workflows, this cycle can eat up hours of your day. And if you're on a team with limited GitHub Actions minutes (for **private repositories**, each GitHub account receives [2,000 free minutes per month](https://docs.github.com/en/billing/concepts/product-billing/github-actions)), those failed runs add up quickly.
...
![prerequisites_.png](attachment:b3f55a2b-903a-4f36-805b-a86dbaddcc5d:prerequisites_.png)
...
3. [**Homebrew**](https://brew.sh/) - we'll use it to install **act** and **Docker Desktop** (on macOS or Linux)
...
![your-first-local-workflow.png](attachment:2dcd1fec-ad74-448f-acd2-71fb4e8ebafa:your-first-local-workflow.png)
...
![running-scheduled-workflows-cron-jobs.png](attachment:76b73f5c-1986-4ddc-982d-80109d71e05c:running-scheduled-workflows-cron-jobs.png)
...
![image_046_light-pastel.png](attachment:1b77c133-7d84-45e2-8f37-3b99a2f1e27d:image_046_light-pastel.png)
...
![matrix-builds.png](attachment:6a5d6cad-209b-49c6-90ca-b15c1a2455be:matrix-builds.png)
...
![working-with-secrets-and-environment-variables.png](attachment:110b7e36-a40c-41a8-9cf3-647cdd07e7b2:working-with-secrets-and-environment-variables.png)
...
![caching-dependencies.png](attachment:26aef392-b66b-45d5-af3d-ca7d144f1aaa:caching-dependencies.png)
...
By now, we've been running GitHub Actions locally through the command line - and for many developers, that's perfectly fine. But if you prefer a more visual approach, there's a fantastic VSCode extension called [**GitHub Local Actions**](https://sanjulaganepola.github.io/github-local-actions-docs/) that lets you run workflows with the click of a button.
...
**Repository**: [run-your-github-actions-locally-with-act](https://github.com/user/run-your-github-actions-locally-with-act)

Happy testing!

## Available Images

- https://res.cloudinary.com/suv4o/image/upload/v1769425117/blog/how-to-run-and-debug-your-github-workflows-locally/how-to-run-and-debug-your-github-workflows-locally_afbogh.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425120/blog/how-to-run-and-debug-your-github-workflows-locally/working-with-secrets-and-environment-variables_zwklto.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425119/blog/how-to-run-and-debug-your-github-workflows-locally/prerequisites__jvksbc.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425117/blog/how-to-run-and-debug-your-github-workflows-locally/your-first-local-workflow_cgggvj.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425116/blog/how-to-run-and-debug-your-github-workflows-locally/running-scheduled-workflows-cron-jobs_k30l7e.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425116/blog/how-to-run-and-debug-your-github-workflows-locally/matrix-builds_oop521.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425116/blog/how-to-run-and-debug-your-github-workflows-locally/why-test-github-actions-locally_yjdtcz.jpg
- https://res.cloudinary.com/suv4o/image/upload/v1769425115/blog/how-to-run-and-debug-your-github-workflows-locally/python-node_pbhfbd.png
- https://res.cloudinary.com/suv4o/image/upload/v1769425115/blog/how-to-run-and-debug-your-github-workflows-locally/caching-dependencies_ccjajc.png
