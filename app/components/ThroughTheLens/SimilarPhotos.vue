        ...
        <div class="pb-8">
            ...
            <div class="mx-auto mt-6 grid auto-rows-fr grid-cols-1 gap-8 sm:mt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                <NuxtLink
                    ...
                    :key="card.id"
                    :to="card.path"
                    class="group block transform transition-all duration-300 ease-in-out hover:scale-[1.02] hover:shadow-xl rounded-2xl"
                >
                    <article
                        class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl bg-gray-900 px-8 pt-80 pb-8 sm:pt-48 lg:pt-80 h-full"
                    >
                        <NuxtImg
                            :src="card.imageUrl"
                            :alt="card.title"
                            ...
                            class="absolute inset-0 -z-10 size-full object-cover transition-transform duration-300 ease-out group-hover:scale-105"
                        />
